...
{
    public class PvrManagementHomeViewModel : VersatileMediaManagerViewModelBase
    {
        ...
        /// CTOR
        /// </summary>
        public PvrManagementHomeViewModel()
        {
        ...
        public IList<IConnection> Connections
        {
            get
            {
                return this.connectionManager.Connections.Where(c => c.ConnectionSettings.ConnectionKind == ConnectionKindsEnum.Enigma2WebInterface).ToList();
            }
        }
